          ...
          <div class="navbar-inner">
            <div class="container">
              <ul class="nav">
                ...
                <li class="active"><a href="./CreateInvitation.jsp">Create Invitation</a></li>
 ...
 <div class="control-group">
  ...
  <div class="control-group">
    ...
    <div class="controls" align=left>
      ...
      <input type="text" id="inputEmail" placeholder="Event Name">
    </div>
  </div>   
  <div class="control-group">
    ...
    <div class="controls" align=left>
      ...
      <input type="text" id="inputEmail" placeholder="Event Type">
    </div>
  </div> 
  <div class="control-group">
    ...
    <div class="controls" align=left>
      ...
      <input type="text" id="inputEmail" placeholder="Event Date">
    </div>
  </div> 
  <div class="control-group">
    ...
    <div class="controls" align=left>
      ...
      <input type="text" id="inputEmail" placeholder="Event Time">
    </div>
  </div> 
  ...
  <div class="control-group">
    ...
    <div class="controls" align=left>
      ...
      <input type="text" id="inputEmail" placeholder="Event Location">
    </div>
  </div> 
  <div class="control-group">
    ...
    <div class="controls" align=left>
      ...
      <input type="text" id="inputEmail" placeholder="Event Host">
    </div>
  </div> 
  <div class="control-group">
    ...
    <div class="controls" align=left>
      ...
      <input type="text" id="inputEmail" placeholder="Host Contact Details">
    </div>
  </div> 
 <div class="control-group">
